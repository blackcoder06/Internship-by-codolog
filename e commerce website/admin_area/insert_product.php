...
if(isset($_POST['insert_product'])){
    ...
    if ($product_title == '' || $description == '' || $product_keyword == '' || $product_category == '' || $product_brands == '' || $product_price == '' || $product_image1 == '' || $product_image2 == '' || $product_image3 == '') {
        ...
        // Insert query
        $insert_products = "INSERT INTO `products` (product_title, product_description, product_keywords, categoroy_id, brand_id, product_image1, product_image2, product_image3, product_price, date, status) VALUES ('$product_title', '$description', '$product_keyword', '$product_category', '$product_brands', '$product_image1', '$product_image2', '$product_image3', '$product_price', NOW(), '$product_status')";
...
<div class="form-outline mb-4 w-50 m-auto">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            class="form-control" placeholder="Enter Product keyword" autocomplete=""off required="required">
